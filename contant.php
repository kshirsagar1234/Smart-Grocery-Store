...
<head>
    ...
    <title>Contact Us - Smart Grocery Store</title>
    <style>
        ...
        <div class="row">
            ...
            <div class="contact-info">
                <div class="contact-info-item">
                    ...
                    <div class="contact-info-content">
                        <h4>Address</h4>
                        <p> Karjat, Ahmednager, Maharashtra, 414402.</p>
                    </div>
                </div>
            ...
            <div class="contact-form">
                <form action="" id="contact-form">
                    <h2>Send Message</h2>
                    <div class="input-box">
                        <input type="text" required="true" name="name" placeholder=" ">
                        <span>Full Name</span>
                    </div>

                    <div class="input-box">
                        <input type="email" required="true" name="email" placeholder=" ">
                        <span>Email</span>
                    </div>

                    <div class="input-box">
                        <textarea required="true" name="message" placeholder=" "></textarea>
